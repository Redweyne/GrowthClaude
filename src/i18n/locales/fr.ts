...
const fr = {
  ...
  home: {
    ...
    lessonCard: {
      allCaughtUpTitle: 'Vous êtes à jour !',
      allCaughtUpBody: 'Vous avez terminé toutes les leçons disponibles dans {world}. Continuez à pratiquer pour renforcer votre sagesse.',
      actionInProgress: 'ACTION EN COURS',
      iveDoneItContinue: 'Je l’ai fait — Continuer',
      todaysLesson: 'Leçon du jour',
      estimatedMinutes: '~{minutes} min',
      lessonOfTotal: 'Leçon {current} sur {total}',
      beginYourJourney: 'Commencer votre parcours',
  ...
  settings: {
    ...
    confirmResetDesc: 'Cela supprimera définitivement toutes vos leçons, réflexions, séries et déclarations d’identité. Vous recommencerez complètement à zéro.',
  ...
  exercises: {
    ...
    agree: 'OUI',
    disagree: 'NON',
    swipeHint: "Glissez vers la droite pour être d'accord, vers la gauche pour ne pas être d'accord",
    seeResults: 'Voir ce que cela révèle',
    dragToReorder: 'Faites glisser pour réorganiser. Votre n°1 va en haut.',
    lockInRanking: 'Valider mon classement',
    yourTopChoice: 'Votre n°1 :',
    forging: 'Création...',
    yourMantra: 'Votre mantra',
    forgeMantra: 'Créer mon mantra',
    selectMore: 'Sélectionnez encore {count}',
    dragToPlace: 'Touchez ou glissez pour positionner, puis placez',
    placeHere: 'Placer ici',
    somethingWentWrong: 'Une erreur est survenue',
    selected: 'sélectionné',
    minRequired: 'min {min}',
    rapidVerdictLabel: 'Verdict Rapide',
    priorityTowerLabel: 'Tour des Priorités',
    scenarioSnapLabel: 'Scénario Flash',
    heatCheckLabel: 'Baromètre',
    wordForgeLabel: 'Forge de Mots',
  ...
  story: {
    ...
    slides: {
      ...
      identityStatementsCreated: '{count} affirmations identitaires créées',
      wordsWrittenInReflection: '{count} mots écrits en réflexion',
      before: 'Avant',
      after: 'Après',
      patternShift: {
    ...
    viewer: {
      title: 'Votre histoire de transformation',
      keyboardHints: '← → naviguer • espace pour avancer • p pour pause • m pour le son',
    },
  },
    ...
    pricing: {
      ...
      founder: {
        ...
        features: {
          ...
          f6: 'Nom dans les crédits',
          f7: 'Reconnaissance permanente',
        },
      },
      checkout: {
  ...
  agora: {
    title: 'L\'Agora',
    subtitle: 'Voix de la communauté',
    ctaTitle: 'Partagez votre voix',
    ctaSubtitle: 'Façonnez l\'avenir de Solon\'s Way',
    filterAll: 'Tout',
    filterIdeas: 'Idées',
    filterBugs: 'Bugs',
    filterLove: 'Coups de cœur',
    filterQuestions: 'Questions',
    sortTop: 'Top',
    sortNew: 'Récent',
    posts: 'posts',
    newPost: 'Nouveau post',
    pickCategory: 'Quel type de post ?',
    postPlaceholder: 'Partagez une idée, signalez un bug, ou dites-nous ce que vous aimez...',
    minWords: 'mots min',
    submitPost: 'Publier dans l\'Agora',
    posting: 'Publication...',
    postPublished: 'Votre voix a été entendue',
    thankYou: 'Merci de façonner ce voyage',
    categoryIdea: 'Idée',
    categoryBug: 'Bug',
    categoryLove: 'Coup de cœur',
