...
const COPY = {
  ...
  fr: {
    beginning: 'Votre chemin commence a peine.',
    waiting: 'Votre histoire de transformation attend encore de se reveler.',
    oneMonthGrowth: 'Vos reflexions montrent deja une base tournee vers la progression.',
    oneMonthChallenge: 'Vous regardez vos difficultes avec honnetete. C est la que la progression commence.',
    oneMonthBalanced: 'Votre chemin a commence par une vraie reflexion sur vous-meme.',
    trajectory: {
      improving: 'Vos schemas de pensee ont nettement evolue.',
      stable: 'Vous avez maintenu une progression reguliere dans votre facon de penser.',
      mixed: 'Votre parcours montre le mouvement naturel de toute progression.',
      declining: 'Vous traversez une phase de difficulte. Cela fait partie du parcours.',
    },
    challengeToGrowth: 'La ou les difficultes dominaient avant, la progression prend maintenant la place centrale.',
    upwardTitle: 'Trajectoire ascendante',
    upwardDescription: 'Votre facon de penser s oriente de plus en plus vers la croissance.',
    trackedAcross: 'Observe sur {count} mois',
    timespan: 'De {from} a {to}',
    amplified: 'Votre {label} s est renforcee de facon nette.',
    shift: {
      major: [
        'Un basculement profond : la ou {from} dominait, {to} a pris racine.',
        'Votre relation a {from} s est transformee en {to}.',
        'Passer de {from} a {to}, c est une vraie transformation.',
      ],
      moderate: [
        '{from} laisse progressivement place a {to} dans vos reflexions.',
        'Vous trouvez davantage de {to} la ou {from} dominait avant.',
        'Le passage de {from} a {to} devient de plus en plus clair.',
      ],
      minor: [
        'Des graines de {to} apparaissent la ou {from} etait plus presente.',
        '{to} commence a remplacer {from}.',
      ],
    },
  },
  ar: {
