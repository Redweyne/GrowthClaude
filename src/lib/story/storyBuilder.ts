...
export const CLOSING_MESSAGES: Record<StoryLocale, Record<StoryMood, string[]>> = {
  ...
  fr: {
    triumphant: ['Vous n avez pas seulement change, vous avez evolue.', 'Cette version de vous est magnifique.', 'Le feu que vous avez construit continuera d eclairer votre route.'],
    ...
    resilient: ['Vous vous etes choisi encore et encore.', 'La constance fait maintenant partie de votre identite.', 'Vous avez continue meme quand il etait plus simple de vous arreter.'],
    awakening: ['Le voyage a commence.', 'Quelque chose de puissant prend racine en vous.', 'Faites confiance au processus. Faites-vous confiance.'],
    transformative: ['La personne qui lit ceci n est plus celle qui a commence.', 'Vous etes la preuve que le changement est possible.', 'Ce que vous avez construit ici est remarquable.'],
  },
  ar: {
...
export const PERSONAL_NOTES: Record<StoryLocale, Record<StoryMood, string>> = {
  ...
  fr: {
    triumphant: 'Chaque reflexion, chaque lecon et chaque jour compte. Cette histoire en est la preuve.',
    reflective: 'La croissance n est pas toujours spectaculaire. Elle vit souvent dans les declics silencieux et les choix que personne ne voit.',
    resilient: 'Il y a eu des moments ou il aurait ete plus simple d arreter. Quelque chose en vous a choisi d avancer quand meme.',
    awakening: 'Une seule etincelle suffit a allumer un feu. Vous avez allume cette etincelle, et le chemin existe desormais vraiment.',
    transformative: 'Si on vous avait montre cette version de vous au debut, vous auriez peut-etre doute. Pourtant la voici.',
  },
  ar: {
...
const COPY = {
  ...
  fr: {
    ...
    milestoneWorth: 'Une etape qui merite d etre celebree',
    ...
    firstLessonFallback: 'Votre premiere lecon',
    openingToday: 'Aujourd hui, quelque chose a bouge en vous.',
    openingDaysAgo: 'Il y a {count} jours, vous avez pris une decision qui a tout change.',
    statHeadline: 'Ce que votre engagement a construit',
    wordsWritten: 'Mots ecrits',
    selfReflection: 'dans vos reflexions',
    lessonsCompleted: 'Lecons terminees',
    wisdomGained: 'sagesse integree',
    currentLevel: 'Niveau actuel',
    reflections: 'Reflexions',
    momentsOfClarity: 'moments de clarte',
    then: 'Avant',
    now: 'Maintenant',
    growthIndicator: '{count} jours entre ces deux moments',
    streak: {
      d30: 'Un mois de dedication continue. Ce n est plus seulement de la discipline, c est devenu vous.',
      d14: 'Deux semaines a vous choisir chaque jour. Cela demande quelque chose de rare.',
      d7: 'Sept jours de presence. L habitude prend racine.',
      best: 'Votre meilleure serie : {count} jours. Vous avez prouve que c est possible. Refaites-le.',
      fallback: 'Chaque jour ou vous choisissez la progression est une victoire. Gardez-le en memoire.',
    },
    identityMessage: 'Les mots faconnent la realite. Vous etes en train d ecrire qui vous devenez.',
    assessmentMessage: 'Votre {label} a progresse de {count} points.',
    wordCloudMessage: 'Le vocabulaire de votre transformation',
    rememberThisMoment: 'Souvenez-vous de cet instant.',
    bestIsYet: 'Le meilleur reste a venir.',
    shareStory: 'Partager votre histoire',
    continueJourney: 'Continuer votre parcours',
    encouragementTriumphant: 'Votre histoire peut aider quelqu un d autre a croire au changement. Partagez-la.',
    ...
    reflectionOn: '- Extrait de ma reflexion du {date}',
  },
  ar: {
