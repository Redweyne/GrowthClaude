...
const lesson1_InstantReframe: FlexibleLesson = {
  ...
  engagementSteps: [
    ...
    },
    {
      ...
      closingText: 'كل ما تحب مُستعار، وليس مُتمَلّك.',
      style: 'grateful',
    ...
    },
    {
      id: 'e-insight',
      type: 'insight',
      text: 'هذا هو "التصور السلبي" — تخيّل الفقد لتفعيل التقدير. إنه ليس كئيباً. إنه أسرع طريق نحو امتنان حقيقي. لست بحاجة للتظاهر. عليك فقط تذكر أن كل شيء مؤقت.',
      source: 'ويليام بي. إيرفاين',
      sourceBook: 'دليل للحياة الطيبة',
      style: 'principle',
    ...
    },
    {
      ...
      type: 'resonanceCheck',
      prompt: 'ما الذي كنت تأخذه كأمر مسلّم به؟',
      instruction: 'اضغط على ما يصيب الهدف',
      options: [
        { id: 'health', text: 'صحتي أو قدرتي الجسدية', emoji: '🫀' },
        { id: 'person', text: 'شخص يحبني', emoji: '💛' },
        { id: 'safety', text: 'الأمان وسقف فوق رأسي', emoji: '🏠' },
        { id: 'senses', text: 'حواسي — البصر، السمع، التذوق', emoji: '👁️' },
        { id: 'freedom', text: 'حرية اختيار طريقي', emoji: '🦅' },
        { id: 'today', text: 'حقيقة أنني استيقظت اليوم', emoji: '☀️' },
        { id: 'access', text: 'الوصول إلى الطعام والماء والدفء', emoji: '🌊' },
        { id: 'moments', text: 'لحظات صغيرة تجعل الحياة جميلة', emoji: '✨' },
      ],
      minSelections: 1,
      maxSelections: 4,
    ...
    },
    {
      ...
      type: 'scaleRating',
      prompt: 'الآن، في هذه اللحظة — ما مدى شعورك بالامتنان؟',
      lowLabel: 'ليس كثيراً',
      highLabel: 'ممتن بعمق',
      steps: 5,
      storeAs: 'gratitude-level',
      responsesByRange: {
        low: 'صادق. الامتنان ليس سهلاً دائماً. لكنك سمّيت ما يهم — تلك هي الخطوة الأولى.',
        mid: 'تشعر به يتحرك. هذه بداية التحول. من التفكير في الامتنان إلى الشعور به.',
        high: 'ذلك الدفء الذي تشعر به؟ هذا ما يحدث عندما تتوقف عن مطاردة المزيد وترى ما هو موجود بالفعل.',
      },
    ...
    },
    {
      ...
      type: 'timer',
      title: 'لحظة حضور',
      instruction: 'أغمض عينيك. اشعر بالامتنان لما سميته للتو. ليس في رأسك — بل في صدرك.',
      durationSeconds: 15,
      timerStyle: 'presence',
      guidanceMessages: [
        'دع التقدير يملؤك.',
    ...
    },
    {
      id: 'e-affirmation',
      type: 'affirmation',
      preText: 'لم تفرض الامتنان. لقد كشفته.',
      statement: 'لا أحتاج المزيد لأكون ممتناً. أحتاج أن أرى ما أملكه بالفعل.',
      subtext: 'من الندرة إلى الوفرة — في تحوّل واحد.',
      confirmLabel: 'أنا أرى ذلك الآن',
      style: 'gratitude',
      nextStepId: 'e-reward',
    },
    {
    ...
    },
    {
      ...
      responses: {
        ...
        byMode: {
          engagement: [
            'لم تكتب قائمة امتنان. لم تجبر نفسك على الشعور بالامتنان. تخيّلت الفقد — وظهر التقدير من تلقاء نفسه. هذا هو السر الرواقي: أنت لا تخلق الامتنان. تكتشفه بتذكر أن كل شيء مؤقت. الأشخاص الذين تحبهم. الجسد الذي تسكنه. هذا اليوم نفسه. كلها مستعارة. كلها ثمينة.',
          ],
        },
      },
    },
