...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    // Variant styles with enhanced visuals - Phase 2 Premium Gradients
    const variants = {
      primary: `
      ...
      warm: `
        ...
        hover:from-rose-400 hover:via-rose-500 hover:to-purple-600
    ...
    // Size variants - Premium generous padding
    const sizes = {
      sm: 'px-6 py-3 text-sm gap-2.5 min-h-[44px]',
      md: 'px-8 py-4 text-base gap-3 min-h-[48px]',
      lg: 'px-10 py-5 text-lg gap-3.5 min-h-[56px]',
    };
    ...
    return (
      ...
      >
        ...
        {/* Enhanced shimmer effect on hover - Phase 2 */}
        <motion.div
