...
const en = {
  ...
  onboarding: {
    ...
    ready: {
      ...
      mentorGuide: 'A mentor will guide you—responding to your reflections',
      withWisdom: 'with wisdom tailored to your journey.',
      youreReady: "you're ready.",
      firstLesson: 'Your first lesson awaits.',
      beginMyJourney: 'Begin My Journey',
      quote: '"The person you become is shaped by what you do every day."',
    },
  },
