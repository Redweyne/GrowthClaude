...
const fr = {
  ...
  onboarding: {
    ...
    ready: {
      ...
      mentorGuide: 'Un mentor vous guidera—répondant à vos réflexions',
      withWisdom: 'avec une sagesse adaptée à votre parcours.',
      youreReady: 'vous êtes prêt.',
      firstLesson: 'Votre première leçon vous attend.',
      beginMyJourney: 'Commencer Mon Voyage',
      quote: '"La personne que vous devenez est façonnée par ce que vous faites chaque jour."',
    },
  },
